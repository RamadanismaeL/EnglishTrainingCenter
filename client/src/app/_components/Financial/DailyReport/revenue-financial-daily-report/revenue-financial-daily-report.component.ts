...
@Component({
  selector: 'app-revenue-financial-daily-report',
  imports: [
    AgGridAngular,
    MatIconModule,
    MatTooltipModule,
  ...
  templateUrl: './revenue-financial-daily-report.component.html',
  styleUrl: './revenue-financial-daily-report.component.scss'
})
export class RevenueFinancialDailyReportComponent implements OnInit, OnDestroy {
  ...
  {
    this.subs.add(
      this.financialService.getListDailyReportRevenue().subscribe((data: any) => {
        this.rowData = data;
