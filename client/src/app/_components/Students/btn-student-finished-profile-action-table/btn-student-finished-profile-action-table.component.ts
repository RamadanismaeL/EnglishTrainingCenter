...
@Component({
  selector: 'app-btn-student-finished-profile-action-table',
  imports: [
    MatIconModule,
    MatTooltipModule,
    RouterLink
  ],
  templateUrl: './btn-student-finished-profile-action-table.component.html',
  styleUrl: './btn-student-finished-profile-action-table.component.scss'
})
export class BtnStudentFinishedProfileActionTableComponent implements ICellRendererAngularComp {
