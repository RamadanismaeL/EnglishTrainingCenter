...
import { BtnStudentScheduledExamActionTableComponent } from '../../btn-student-scheduled-exam-action-table/btn-student-scheduled-exam-action-table.component';
...
@Component({
  ...
  templateUrl: './scheduled-exam.component.html',
  styleUrl: './scheduled-exam.component.scss'
})
export class ScheduledExamComponent implements OnInit, OnDestroy {
