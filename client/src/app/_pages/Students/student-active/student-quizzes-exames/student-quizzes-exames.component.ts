...
@Component({
  selector: 'app-student-quizzes-exames',
  imports: [
    AgGridAngular,
    MatIconModule,
    MatTooltipModule,
...
export class StudentQuizzesExamesComponent implements OnInit, OnDestroy {
  ...
  columnDefs: ColDef[] =
    [
      ...
      },
      {
        headerName: 'Actions',
        minWidth: 110, flex: 1,
        cellRenderer: BtnStudentQuizzesExamActionTableComponent,
        cellClass: 'custom-cell-center'
      }
    ];
