...
@Component({
  selector: 'app-student-dropouts-profile',
  imports: [
    MatMenuModule,
    MatIconModule,
    RouterLink,
  ...
  templateUrl: './student-dropouts-profile.component.html',
  styleUrl: './student-dropouts-profile.component.scss'
})
export class StudentDropoutsProfileComponent implements OnInit, OnDestroy {
