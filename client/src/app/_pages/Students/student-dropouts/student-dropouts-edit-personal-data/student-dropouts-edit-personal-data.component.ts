...
@Component({
  selector: 'app-student-dropouts-edit-personal-data',
  imports: [
    MatInputModule,
    MatIconModule,
    MatSelectModule,
  ...
  templateUrl: './student-dropouts-edit-personal-data.component.html',
  styleUrl: './student-dropouts-edit-personal-data.component.scss'
})
export class StudentDropoutsEditPersonalDataComponent implements OnInit, OnDestroy {
