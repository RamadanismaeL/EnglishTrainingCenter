...
@Component({
  selector: 'app-payment-drop-success',
  imports: [],
  templateUrl: './payment-drop-success.component.html',
  styleUrl: './payment-drop-success.component.scss'
})
export class PaymentDropSuccessComponent implements OnInit, OnDestroy, ICellRendererAngularComp {
