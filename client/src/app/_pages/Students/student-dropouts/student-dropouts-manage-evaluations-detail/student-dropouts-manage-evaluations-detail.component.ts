...
@Component({
  selector: 'app-student-dropouts-manage-evaluations-detail',
  imports: [
    CommonModule,
    ReactiveFormsModule,
    AgGridAngular,
  ...
  templateUrl: './student-dropouts-manage-evaluations-detail.component.html',
  styleUrl: './student-dropouts-manage-evaluations-detail.component.scss'
})
export class StudentDropoutsManageEvaluationsDetailComponent implements OnInit, OnDestroy {
