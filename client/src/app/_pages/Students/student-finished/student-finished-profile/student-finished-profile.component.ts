...
@Component({
  selector: 'app-student-finished-profile',
  imports: [
    MatMenuModule,
    MatIconModule,
    RouterLink,
  ...
  templateUrl: './student-finished-profile.component.html',
  styleUrl: './student-finished-profile.component.scss'
})
export class StudentFinishedProfileComponent implements OnInit, OnDestroy {
