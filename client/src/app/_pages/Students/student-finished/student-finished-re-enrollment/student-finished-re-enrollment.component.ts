...
@Component({
  ...
  templateUrl: './student-finished-re-enrollment.component.html',
  styleUrl: './student-finished-re-enrollment.component.scss'
})
export class StudentFinishedReEnrollmentComponent implements OnInit, OnDestroy {
  ...
  @ViewChild('studentPaymentReEnrollmentFormRef') studentPaymentFormRef!: ElementRef<HTMLFormElement>;
