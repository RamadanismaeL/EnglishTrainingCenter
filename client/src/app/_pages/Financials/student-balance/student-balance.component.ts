...
import { BtnResumeTableComponent } from '../../../_components/Financial/StudentBalance/btn-resume-table/btn-resume-table.component';
...
@Component({
  ...
  styleUrl: './student-balance.component.scss'
})
export class StudentBalanceComponent implements OnInit, OnDestroy {
  ...
  columnDefs: ColDef[] =
    [
      {
        headerName: 'Code',
        field: 'studentID', minWidth: 130, flex: 1,
      ...
      },
      {
        ...
        cellRenderer: (params: any) => {
          ...
          { return '<span style="color:rgb(0, 90, 163);">Active</span>'; }
          else if (params.value === "Inactive")
          { return '<span style="color:rgb(163, 0, 0);">Inactive</span>'; }
          else if (params.value === "Completed")
          { return '<span style="color: rgb(38, 163, 0);">Completed</span>'; }

          return ""
        }
      },
      {
        headerName: 'F. Summary',
        minWidth: 100, flex: 1,
        cellRenderer: BtnResumeTableComponent,
        cellClass: 'custom-cell-center'
      }
    ];
  ...
  {
    this.subs.add(
      this.studentService.getListStudentBalance().subscribe((data: any) => {
        this.rowData = data;
